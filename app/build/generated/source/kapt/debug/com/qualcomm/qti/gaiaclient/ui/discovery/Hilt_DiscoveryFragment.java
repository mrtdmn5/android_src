...
public abstract class Hilt_DiscoveryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DiscoveryFragment() {
    super();
  }

  Hilt_DiscoveryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DiscoveryFragment_GeneratedInjector) this.generatedComponent()).injectDiscoveryFragment(UnsafeCasts.<DiscoveryFragment>unsafeCast(this));
    }
  }
