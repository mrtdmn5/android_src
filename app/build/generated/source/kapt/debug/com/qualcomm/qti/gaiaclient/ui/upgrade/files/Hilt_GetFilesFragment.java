...
public abstract class Hilt_GetFilesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GetFilesFragment() {
    super();
  }

  Hilt_GetFilesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GetFilesFragment_GeneratedInjector) this.generatedComponent()).injectGetFilesFragment(UnsafeCasts.<GetFilesFragment>unsafeCast(this));
    }
  }
