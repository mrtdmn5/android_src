...
abstract class Hilt_ConfigurationListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ConfigurationListFragment() {
    super();
  }

  Hilt_ConfigurationListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConfigurationListFragment_GeneratedInjector) this.generatedComponent()).injectConfigurationListFragment(UnsafeCasts.<ConfigurationListFragment>unsafeCast(this));
    }
  }
