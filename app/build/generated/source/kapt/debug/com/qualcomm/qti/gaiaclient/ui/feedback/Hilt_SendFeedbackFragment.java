...
public abstract class Hilt_SendFeedbackFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SendFeedbackFragment() {
    super();
  }

  Hilt_SendFeedbackFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SendFeedbackFragment_GeneratedInjector) this.generatedComponent()).injectSendFeedbackFragment(UnsafeCasts.<SendFeedbackFragment>unsafeCast(this));
    }
  }
