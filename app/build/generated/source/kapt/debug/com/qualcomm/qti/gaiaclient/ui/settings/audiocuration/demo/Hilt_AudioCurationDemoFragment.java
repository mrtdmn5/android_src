...
abstract class Hilt_AudioCurationDemoFragment<S extends Settings, VD extends SettingsViewData<S>, VM extends SettingsViewModel<S, VD>> extends SettingsFragment<S, VD, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AudioCurationDemoFragment_GeneratedInjector) this.generatedComponent()).injectAudioCurationDemoFragment(UnsafeCasts.<AudioCurationDemoFragment>unsafeCast(this));
    }
  }
