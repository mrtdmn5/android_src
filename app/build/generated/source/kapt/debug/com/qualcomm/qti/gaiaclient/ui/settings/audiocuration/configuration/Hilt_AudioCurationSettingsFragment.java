...
abstract class Hilt_AudioCurationSettingsFragment<S extends Settings, VD extends SettingsViewData<S>, VM extends SettingsViewModel<S, VD>> extends SettingsFragment<S, VD, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AudioCurationSettingsFragment_GeneratedInjector) this.generatedComponent()).injectAudioCurationSettingsFragment(UnsafeCasts.<AudioCurationSettingsFragment>unsafeCast(this));
    }
  }
