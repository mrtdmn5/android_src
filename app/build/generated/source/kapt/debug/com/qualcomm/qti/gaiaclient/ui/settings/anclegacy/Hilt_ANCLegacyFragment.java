...
abstract class Hilt_ANCLegacyFragment<S extends Settings, VD extends SettingsViewData<S>, VM extends SettingsViewModel<S, VD>> extends SettingsFragment<S, VD, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ANCLegacyFragment_GeneratedInjector) this.generatedComponent()).injectANCLegacyFragment(UnsafeCasts.<ANCLegacyFragment>unsafeCast(this));
    }
  }
