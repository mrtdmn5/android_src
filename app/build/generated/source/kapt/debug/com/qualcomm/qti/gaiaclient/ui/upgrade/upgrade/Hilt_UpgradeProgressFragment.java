...
abstract class Hilt_UpgradeProgressFragment<D, O, VM extends ProgressViewModel<D, O>> extends ProgressFragment<D, O, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpgradeProgressFragment_GeneratedInjector) this.generatedComponent()).injectUpgradeProgressFragment(UnsafeCasts.<UpgradeProgressFragment>unsafeCast(this));
    }
  }
