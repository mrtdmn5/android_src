...
abstract class Hilt_EarbudFitFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EarbudFitFragment() {
    super();
  }

  Hilt_EarbudFitFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EarbudFitFragment_GeneratedInjector) this.generatedComponent()).injectEarbudFitFragment(UnsafeCasts.<EarbudFitFragment>unsafeCast(this));
    }
  }
