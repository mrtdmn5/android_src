...
abstract class Hilt_GesturesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GesturesFragment() {
    super();
  }

  Hilt_GesturesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GesturesFragment_GeneratedInjector) this.generatedComponent()).injectGesturesFragment(UnsafeCasts.<GesturesFragment>unsafeCast(this));
    }
  }
