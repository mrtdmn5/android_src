...
public class BR {
  ...
  public static final int isInProgress = 10;

  public static final int isRecording = 11;

  public static final int labelForValue = 12;

  public static final int leftTouchpadData = 13;

  public static final int max = 14;

  public static final int maxValue = 15;

  public static final int maximumLength = 16;

  public static final int message = 17;

  public static final int minValue = 18;

  public static final int placeholder = 19;

  public static final int progress = 20;

  public static final int rate = 21;

  public static final int rightTouchpadData = 22;

  public static final int staticData = 23;
  ...
  public static final int viewData = 28;
