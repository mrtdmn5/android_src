...
abstract class Hilt_GestureConfigurationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GestureConfigurationFragment() {
    super();
  }

  Hilt_GestureConfigurationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GestureConfigurationFragment_GeneratedInjector) this.generatedComponent()).injectGestureConfigurationFragment(UnsafeCasts.<GestureConfigurationFragment>unsafeCast(this));
    }
  }
