...
public abstract class Hilt_UpgradeSettingsFragment<S extends PersistentSettings, VD extends SettingsViewData<S>, M extends SettingsViewModel<S, VD>> extends PersistentSettingsFragment<S, VD, M> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpgradeSettingsFragment_GeneratedInjector) this.generatedComponent()).injectUpgradeSettingsFragment(UnsafeCasts.<UpgradeSettingsFragment>unsafeCast(this));
    }
  }
