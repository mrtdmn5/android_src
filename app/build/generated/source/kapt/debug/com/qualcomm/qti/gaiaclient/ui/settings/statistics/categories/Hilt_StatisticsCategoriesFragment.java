...
public abstract class Hilt_StatisticsCategoriesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StatisticsCategoriesFragment() {
    super();
  }

  Hilt_StatisticsCategoriesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StatisticsCategoriesFragment_GeneratedInjector) this.generatedComponent()).injectStatisticsCategoriesFragment(UnsafeCasts.<StatisticsCategoriesFragment>unsafeCast(this));
    }
  }
