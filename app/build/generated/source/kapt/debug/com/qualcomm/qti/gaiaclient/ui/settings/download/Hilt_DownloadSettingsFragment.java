...
public abstract class Hilt_DownloadSettingsFragment<S extends PersistentSettings, VD extends SettingsViewData<S>, M extends SettingsViewModel<S, VD>> extends PersistentSettingsFragment<S, VD, M> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DownloadSettingsFragment_GeneratedInjector) this.generatedComponent()).injectDownloadSettingsFragment(UnsafeCasts.<DownloadSettingsFragment>unsafeCast(this));
    }
  }
