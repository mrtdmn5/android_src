...
public abstract class Hilt_MusicProcessingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MusicProcessingFragment() {
    super();
  }

  Hilt_MusicProcessingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MusicProcessingFragment_GeneratedInjector) this.generatedComponent()).injectMusicProcessingFragment(UnsafeCasts.<MusicProcessingFragment>unsafeCast(this));
    }
  }
