...
public class FeedbackItemBindingImpl extends FeedbackItemBinding  {
    ...
    public FeedbackItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private FeedbackItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x5L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.contentTextView, content);
        }
        if ((dirtyFlags & 0x6L) != 0) {
            // api target 1
