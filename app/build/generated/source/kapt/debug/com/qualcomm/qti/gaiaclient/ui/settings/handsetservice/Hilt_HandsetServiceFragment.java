...
abstract class Hilt_HandsetServiceFragment<S extends Settings, VD extends SettingsViewData<S>, VM extends SettingsViewModel<S, VD>> extends SettingsFragment<S, VD, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HandsetServiceFragment_GeneratedInjector) this.generatedComponent()).injectHandsetServiceFragment(UnsafeCasts.<HandsetServiceFragment>unsafeCast(this));
    }
  }
