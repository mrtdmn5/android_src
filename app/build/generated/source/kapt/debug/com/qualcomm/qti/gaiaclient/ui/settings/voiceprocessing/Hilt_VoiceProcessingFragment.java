...
abstract class Hilt_VoiceProcessingFragment<S extends Settings, VD extends SettingsViewData<S>, VM extends SettingsViewModel<S, VD>> extends SettingsFragment<S, VD, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VoiceProcessingFragment_GeneratedInjector) this.generatedComponent()).injectVoiceProcessingFragment(UnsafeCasts.<VoiceProcessingFragment>unsafeCast(this));
    }
  }
