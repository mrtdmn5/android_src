...
abstract class Hilt_ConnectionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ConnectionFragment() {
    super();
  }

  Hilt_ConnectionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConnectionFragment_GeneratedInjector) this.generatedComponent()).injectConnectionFragment(UnsafeCasts.<ConnectionFragment>unsafeCast(this));
    }
  }
