...
abstract class Hilt_LogsSettingsFragment<S extends Settings, VD extends SettingsViewData<S>, VM extends SettingsViewModel<S, VD>> extends SettingsFragment<S, VD, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LogsSettingsFragment_GeneratedInjector) this.generatedComponent()).injectLogsSettingsFragment(UnsafeCasts.<LogsSettingsFragment>unsafeCast(this));
    }
  }
