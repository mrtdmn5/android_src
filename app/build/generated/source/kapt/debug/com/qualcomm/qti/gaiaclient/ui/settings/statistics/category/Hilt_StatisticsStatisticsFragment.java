...
public abstract class Hilt_StatisticsStatisticsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StatisticsStatisticsFragment() {
    super();
  }

  Hilt_StatisticsStatisticsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StatisticsStatisticsFragment_GeneratedInjector) this.generatedComponent()).injectStatisticsStatisticsFragment(UnsafeCasts.<StatisticsStatisticsFragment>unsafeCast(this));
    }
  }
