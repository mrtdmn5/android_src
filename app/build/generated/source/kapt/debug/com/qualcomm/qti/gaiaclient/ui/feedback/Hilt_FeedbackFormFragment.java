...
public abstract class Hilt_FeedbackFormFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FeedbackFormFragment() {
    super();
  }

  Hilt_FeedbackFormFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FeedbackFormFragment_GeneratedInjector) this.generatedComponent()).injectFeedbackFormFragment(UnsafeCasts.<FeedbackFormFragment>unsafeCast(this));
    }
  }
