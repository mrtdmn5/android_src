...
abstract class Hilt_DownloadLogsFragment<D, O, VM extends ProgressViewModel<D, O>> extends ProgressFragment<D, O, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DownloadLogsFragment_GeneratedInjector) this.generatedComponent()).injectDownloadLogsFragment(UnsafeCasts.<DownloadLogsFragment>unsafeCast(this));
    }
  }
