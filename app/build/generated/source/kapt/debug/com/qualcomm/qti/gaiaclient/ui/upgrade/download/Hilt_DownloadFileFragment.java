...
public abstract class Hilt_DownloadFileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DownloadFileFragment() {
    super();
  }

  Hilt_DownloadFileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DownloadFileFragment_GeneratedInjector) this.generatedComponent()).injectDownloadFileFragment(UnsafeCasts.<DownloadFileFragment>unsafeCast(this));
    }
  }
